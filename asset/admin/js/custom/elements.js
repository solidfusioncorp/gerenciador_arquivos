jQuery(document).ready(function(){
	...
	**/
	...
	jQuery('.confirmbutton').click(function(){
		jConfirm('', 'Excluir este registro?', function(r) {
			
			jAlert('<a href="" class="btn btn3 btn_search" title="Visualizar"></a>');
		});
		return false;
	});
	...
	jQuery('.alerthtmlbutton').click(function(){
		jAlert('Deseja realmente deletar este registro?<br> <a href="" class="btn btn3 btn_search" title="Visualizar"></a>');
		return false;
	});
